...
Gets or sets the CSDL documentation summary or `Core.Description` for this singleton.
...
Gets or sets the CSDL long description or `Core.LongDescription` for this singleton.
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> TypeNamespace
