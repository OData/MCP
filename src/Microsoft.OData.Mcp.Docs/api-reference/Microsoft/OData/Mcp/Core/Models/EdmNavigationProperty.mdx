...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> ContainsTarget
...
Gets or sets the CSDL documentation summary or `Core.Description` for this navigation.
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> IsRequired
...
Gets or sets the CSDL long description or `Core.LongDescription` for this navigation.
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Multiplicity
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> OnDelete
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Partner
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> ReferentialConstraints
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> TargetType
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> TargetTypeName
