...
Gets or sets the CSDL documentation summary or `Core.Description` for this action.
...
Gets or sets the CSDL long description or `Core.LongDescription` for this action.
