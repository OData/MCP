---
title: ApplicationInsightsConfiguration
description: "Azure Application Insights configuration."
icon: lock
sidebarTitle: ApplicationInsightsConfiguration
tag: "SEALED"
keywords: ['ApplicationInsightsConfiguration', 'Microsoft.OData.Mcp.Core.Configuration.ApplicationInsightsConfiguration', 'Microsoft.OData.Mcp.Core.Configuration', 'class', 'System.Object']
---
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  InstrumentationKey
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} />  SamplingPercentage
...
| Name | Type | Description |
|------|------|-------------|
| `other` | `Microsoft.OData.Mcp.Core.Configuration.ApplicationInsightsConfiguration` | The configuration to merge. |
