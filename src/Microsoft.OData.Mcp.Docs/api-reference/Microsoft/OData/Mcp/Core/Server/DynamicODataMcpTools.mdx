...
```csharp
public DynamicODataMcpTools(System.Net.Http.IHttpClientFactory httpClientFactory, Microsoft.Extensions.Options.IOptions<Microsoft.OData.Mcp.Core.Configuration.McpServerConfiguration> configuration, Microsoft.OData.Mcp.Core.Parsing.ICsdlMetadataParser metadataParser, Microsoft.Extensions.Logging.ILogger<Microsoft.OData.Mcp.Core.Server.DynamicODataMcpTools> logger, System.Collections.Generic.IEnumerable<Microsoft.OData.Mcp.Core.Models.EdmModel> edmModels)
```
...
| `edmModels` | `System.Collections.Generic.IEnumerable<Microsoft.OData.Mcp.Core.Models.EdmModel>` | The collection of EDM models to use for tool operations. |
...
```csharp
public string DescribeEntityType(string entityTypeName)
```
...
```csharp
public string GenerateQueryExamples(string entitySetName, bool includeAdvanced = false)
```
...
```csharp
public string ValidateQuery(string queryUrl)
```
