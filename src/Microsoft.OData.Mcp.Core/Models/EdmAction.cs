...
namespace Microsoft.OData.Mcp.Core.Models
{
    ...
    public sealed class EdmAction
    {
        ...
        /// <summary>
        /// Gets or sets the CSDL documentation summary or <c>Core.Description</c> for this action.
        /// </summary>
        /// <value>A human-readable summary from metadata, or <c>null</c> when none is declared.</value>
        public string? Description { get; set; }

        /// <summary>
        /// Gets or sets the CSDL long description or <c>Core.LongDescription</c> for this action.
        /// </summary>
