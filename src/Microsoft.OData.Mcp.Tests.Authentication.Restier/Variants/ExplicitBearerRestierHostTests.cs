...
namespace Microsoft.OData.Mcp.Tests.Authentication.Restier.Variants
{
    ...
    /// <summary>
    /// The same secured Restier host reached with a token the operator pasted on the command line, which is the
    ...
    /// is what proves it: the only traffic in this run is the secured Restier service itself.
    /// </remarks>
    [TestClass]
    public class ExplicitBearerRestierHostTests : OutboundRestierVariantHost
    {

        #region Constructors

        /// <summary>
        /// Initializes a new instance of the <see cref="ExplicitBearerRestierHostTests"/> class.
        /// </summary>
        public ExplicitBearerRestierHostTests()
            : base("ExplicitBearerRestierHost")
        {
        }
        ...
        {
            await RunRepresentativeToolsAsync(40);
