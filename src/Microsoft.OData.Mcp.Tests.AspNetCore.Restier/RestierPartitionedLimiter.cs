...
namespace Microsoft.OData.Mcp.Tests.AspNetCore.Restier
{
    ...
    /// <summary>
    /// Independent Restier limiters for two API prefixes and their MCP endpoints.
    /// </summary>
    public static class RestierPartitionedLimiter
    {
        ...
        /// <param name="budget">Per-path permits.</param>
        public static void Apply(RateLimiterOptions options, RestierRateLimitBudget budget)
        {
            ...
            options.GlobalLimiter = PartitionedRateLimiter.Create<HttpContext, string>(context =>
            {
                ...
                {
                    return Partition("odata-mcp", budget.OdataMcp);
                }
        ...
        /// <summary>
        /// Unlimited or a one-hour window with <paramref name="permit"/> permits.
        /// </summary>
