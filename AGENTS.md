...
* NEVER modify the generated API `.mdx` files under `src/Microsoft.OData.Mcp.Docs/api-reference/` when reorganizing code (moving files, renaming classes, changing namespaces, and so on).
